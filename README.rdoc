...
=== Returning only select columns

By default pg_search_scope will return all of the columns for the table as well as the calculated pg_search_rank value.
You can set the select configuration option to only select the columns you want from your table.

    pg_search_scope :select_search,
                    :select => { :word }
