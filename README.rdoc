...
A second optional argument can be passed to specify the Postgres schema against which the rebuild should be made. The following will set the schema to "2" before doing the reindexing.

 $ rake pg_search:multisearch:rebuild[BlogPost,public]
